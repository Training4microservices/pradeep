...
public class EmployeeController {
  ...
  private Employee getEmployeeById(@PathVariable("id") int id) {
    ...
    if(employeeService.getEmployeeSal(id)<employeeService.getAvgEmpSal())
    {
      throw new EmployeeInsufficientSalaryException("Employee salary is less than the average salary -" + id);
    }
    else {
